...
class SimplePrioritizerTest {
    ...
    private static Notam mkNotam(
            String id, String type, String icao, String issuedIso,
            double lat, double lon, Double radiusNm, String text
    ) {
        return new Notam(
                id, "5/31", type,
                OffsetDateTime.parse(issuedIso),
                icao, lat, lon, radiusNm, text
        );
    }
    ...
    void appliesKeywordAndTypeWeights() {
        ...
        Notam base = mkNotam("X", "RUNWAY", "KATL", "2025-10-04T20:00:00Z",
                33.6407, -84.4277, 10.0, "RWY 8L OPEN");

        Notam closed = mkNotam("Y", "RUNWAY", "KATL", "2025-10-04T20:00:00Z",
        ...
        Notam airspace = mkNotam("Z", "AIRSPACE", "KATL", "2025-10-04T20:00:00Z",
    ...
    void recencyAffectsScore_andTimezoneOffsetsHandled() {
        ...
        Notam zulu = mkNotam("Z1", "RUNWAY", "KATL", "2025-10-04T20:00:00Z",
                33.6407, -84.4277, 3.0, "RWY CLOSED");
        Notam offset = mkNotam("Z2", "RUNWAY", "KATL", "2025-10-04T15:00:00-05:00",
                33.6407, -84.4277, 3.0, "RWY CLOSED"); // same instant as 20:00Z

        assertEquals(pr.score(zulu), pr.score(offset), 1e-9);

        Notam older = mkNotam("Z3", "RUNWAY", "KATL", "2025-10-03T20:00:00Z",
                33.6407, -84.4277, 3.0, "RWY CLOSED");
